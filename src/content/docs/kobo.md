...
If the proxy also adds its own login, such as Cloudflare Access or Authelia, the Kobo cannot sign in and needs several paths excused from that login. See [Authentication Proxies](/auth-proxies).
